...
public class AppConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
       ...
       /* source.registerCorsConfiguration("/v3/api-docs/**", apiConfig);
        source.registerCorsConfiguration("/swagger-ui/**", apiConfig);
        source.registerCorsConfiguration("/swagger-ui.html", apiConfig);*/
